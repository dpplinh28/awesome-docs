...
const config: Config = {
  ...
  organizationName: "dpplinh28", // Usually your GitHub org/user name.
  projectName: "awesome-docs", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/dpplinh28/awesome-docs/tree/main/",
        },
        blog: {
